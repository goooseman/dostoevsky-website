...
class BubblesD3Chart extends React.Component<BubblesD3Props> {
  public static defaultProps: Partial<BubblesD3Props> = {
    graph: {
      zoom: 1.0,
      offsetX: 0.0,
      offsetY: 0.0,
  ...
  private svg: SVGSVGElement | null | undefined;
