        ...
        <Container isThin>
          <SinglePageLayout title={<T message="О проекте" />}>
            <>
              ...
              <Typography>
                <T message="Можете. Все данные Достоевского генерируются на основе официальной статистики Судебного департамента при Верховном суде РФ. Однако эта информация публикуется в виде десятков нечитаемых таблиц: для подробного анализа квалифицированному специалисту требуются часы, а иногда и дни работы." />
              </Typography>
