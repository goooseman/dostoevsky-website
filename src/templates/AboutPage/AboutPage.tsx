        ...
        <Container isThin>
          <SinglePageLayout title={<T message="О проекте" />}>
            <>
              ...
              <Typography>
                <T message="Наш проект стал возможен благодаря труду десятков людей — юристов, дата-аналитиков, разработчиков, дизайнеров, журналистов и менеджеров, а также благодаря тщательной работе Судебного департамента при Верховном суде РФ, который неустанно ведeт учeт преступлений и наказаний в России. Спасибо!" />
              </Typography>
            </>
          </SinglePageLayout>
        </Container>
