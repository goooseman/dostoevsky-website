      ...
      <Typography>
        <ol type="I" className={cn(classes.ulWithAdditionalMargin)}>
          ...
          <li>
            ...
            <T message="(exemption). Мы не знаем, является ли эта категория в статистике Судебного департамента одним из исходов дела, наряду с обвинением и оправданием, или дополнительной характеристикой тех случаев, когда человека осудили (всего осуждено (totalConvicted)), поэтому мы включили её в оба раздела. Категории нет в таблице, дана детализация по видам:" />
            <ol>
              <li>
                <T message="Освобождение от наказания" />{" "}
                <b>
      ...
      <Typography>
        <ol type="I" className={cn(classes.ulWithAdditionalMargin)}>
          ...
          <li>
            ...
            <T message="Мы не знаем, интерпретирует ли Судебный департамент эти данные как детализацию прекращения дел по реабилитирующим обстоятельствам или как дополнительную характеристику по основному составу, поэтому включили эту категорию в оба раздела. Категории нет в таблице, дана детализация по видам:" />
            <ol type="a">
              <li>
                <T message="Обстоятельства исключающие преступность деяния:" />{" "}
                <b>
