      ...
      <Typography>
        <ol type="I" className={cn(classes.ulWithAdditionalMargin)}>
          <li>
            ...
            <ol>
              ...
              <li>
                ...
                <FaqPageTooltip tip="раздел «Основной состав», пункт I.4." />
              ...
              <li>
                ...
                <ol type="a">
                  ...
                  <li>
                    ...
                    <FaqPageTooltip tip="раздел «Основной состав», пункт III.1.b. и раздел «Дополнительные характеристики по основному составу», пункт 7." />
                    <T message="Категории нет в таблице, дана детализация по видам:" />
                    <ul>
                      <li>
                        <T message="Обстоятельства, исключающие преступность деяния:" />{" "}
          ...
          <li>
            ...
            <FaqPageTooltip tip="Раздел «Основной состав», пункт V и раздел «Дополнительные характеристики по основному составу», пункт V." />
            <T message="Категории нет в таблице, дана детализация по видам:" />
            <ol>
              <li>
                <T message="Освобождение от наказания" />{" "}
      ...
      <Typography>
        <ol type="I" className={cn(classes.ulWithAdditionalMargin)}>
          ...
          <li>
            ...
            <FaqPageTooltip tip="раздел «Основной состав», пункт III.1.a. и раздел «Дополнительные характеристики по основному составу», пункт VII." />
            <T message="Категории нет в таблице, дана детализация по видам:" />
            <ol type="a">
              <li>
                <T message="Обстоятельства, исключающие преступность деяния:" />{" "}
